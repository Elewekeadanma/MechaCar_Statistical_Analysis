...
A multiple linear regression test will be sufficient to use since my data is continuous. I consider it continous because it is data that has been collected over a period of time.
